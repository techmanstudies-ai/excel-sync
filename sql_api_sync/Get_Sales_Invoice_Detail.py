...
WORKSHEET_NAME = "Sales_Invoice_Detail"
...
print(f"Existing detail rows: {len(existing_keys)}")
...
print("\nPhase 2: Downloading sales invoice details...")
...
while True:
    ...
    for h in headers:
        ...
        lines = header_block.get("sdsdocdetail", [])
